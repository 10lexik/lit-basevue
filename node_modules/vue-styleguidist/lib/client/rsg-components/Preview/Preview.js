...
var Preview = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Preview, [{
    ...
    value: function executeCode() {
      ...
      var example;
      try {
        example = compile(code, _objectSpread(_objectSpread(_objectSpread({}, this.context.config.compilerConfig), this.context.config.jsxInExamples ? {
          jsx: '__pragma__(h)',
      ...
      var _getCompiledExampleCo = getCompiledExampleComponent({
          ...
          destroyVueInstance: function destroyVueInstance() {
            return _this2.destroyVueInstance();
          },
